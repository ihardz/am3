...
const routes = [
    { path: '', loadChildren: () => __webpack_require__.e(/*! import() | am3-layout */ "am3-layout").then(__webpack_require__.bind(null, /*! @am3/layout */ "../../libs/layout/src/index.ts")).then(x => x.LayoutModule) }
];
